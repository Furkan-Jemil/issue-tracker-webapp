...
export function CommentThread({
  ...
  return (
    <Card className="overflow-hidden border-slate-200/80 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
      {/* Header */}
      <CardHeader className="flex-row items-center justify-between border-b border-slate-100 bg-slate-50/70 px-5 py-3 dark:border-zinc-800 dark:bg-zinc-900/60">
        <CardTitle
          id="comments-heading"
          className="flex items-center gap-2 text-[11px] font-semibold uppercase tracking-wider text-slate-400 dark:text-zinc-500"
        >
