...
export function AppShell({
  ...
  return (
    <div className="min-h-screen bg-background">
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-40 flex w-16 flex-col border-r border-border/70 bg-card/95 backdrop-blur-md md:w-20",
        )}>
        ...
        <div className="space-y-2 border-b border-border/70 p-2">
          <div className="flex items-center justify-center">
            <div className="group relative">
              <button
                ...
                className="flex h-11 w-11 items-center justify-center rounded-full border border-border/80 bg-muted/50 text-xs font-semibold text-primary shadow-sm transition-colors hover:bg-accent">
                {profileInitials}
              </button>
              <div className="pointer-events-none absolute left-12 top-0 z-40 min-w-[200px] rounded-xl border border-border/70 bg-popover/95 px-3 py-2.5 opacity-0 shadow-lg backdrop-blur-sm transition-opacity duration-150 group-hover:opacity-100 group-focus-within:opacity-100">
          ...
          <NotificationBell className="h-11 w-full justify-center rounded-xl border border-border/70 bg-background text-muted-foreground hover:bg-accent hover:text-accent-foreground" />
          <Button
            asChild
            variant="outline"
            className="h-11 w-full justify-center rounded-xl border-border/70 px-0">
